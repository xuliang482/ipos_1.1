        ...
        <div class="row">
            <div class="col-md-12">
            	<div class="box box-info">
					...
					<!-- form start -->
					{!! Form::model($item, array('route' => array('items.update', $item->id), 'method' => 'PUT', 'files' => true,'class'=>'form-horizontal')) !!}
					<div class="box-body">
...
@section('scripts')
	...
	<script>
		...
		$("#avatar").fileinput({
			...
			initialPreview: [
				"{{url("/images/items/".$item->avatar)}}"
			],
			initialPreviewConfig: [
				{caption: "{{$item->avatar}}", size: 329892, width: "120px", url: "{{url("/images/items/".$item->avatar)}}", key: 1}
			]
		});
